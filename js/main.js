...
agClinical.util = {
	main:null,
	siteSetupList: [],
	version: AgMobileStorage.getItem('version') || 'agclinical-3.1.1.0',
	encodeVersion: 'agclinical_3__1__1__0',
	contextPath: AgMobileStorage.getItem('contextPath') || 'http://192.168.112.148:8886/agweb',
	...
	saveSettings: function(version, URL) {
		if (version) {
			AgClinicalMobileUtil.version = version;
			AgMobileStorage.setItem('version', version);
		}
		if (URL) {
			AgClinicalMobileUtil.contextPath = URL;
			AgMobileStorage.setItem('contextPath', URL);
		}
	}
};
